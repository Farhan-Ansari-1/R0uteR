...
def build_recon_report(
    ...
    lines = [
        ...
        "",
        "Executive summary:",
        "The current evidence suggests a bounded reconnaissance result with a defined exposure surface and actionable next steps.",
        "",
        "Current risk posture:",
        "The environment is being assessed from an approved scope and the observed exposure should be triaged before deeper validation.",
        "",
        "Summary:",
        summary.strip(),
        "",
